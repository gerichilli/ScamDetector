    ...
    <section className="content-narrow">
      <form className="panel form-grid" onSubmit={submit}>
        ...
        <label>
          ...
          <input name="phone_number" required placeholder="VD: 0987654321" />
        </label>
        <label>
          Thời lượng cuộc gọi, tính bằng giây
          <input name="duration_seconds" type="number" min="0" placeholder="VD: 120" />
        </label>
        <label>
          Người gọi đã nói gì?
          <textarea
        ...
        {result && (
          <div className="call-alert-result">
